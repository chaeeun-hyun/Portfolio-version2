          ...
          >
            <div>
              <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-bold leading-[0.85] tracking-tighter mb-12">
                Crafting Brands,<br />
                <span className="text-accent">Connecting Talent.</span>
              </h1>
              <div className="flex flex-wrap items-center gap-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-[1px] bg-accent"></div>
                  <span className="text-sm font-bold text-zinc-400 uppercase tracking-[0.3em]">HR Marketer</span>
                </div>
                <div className="flex gap-2">
                  {["Recruiting", "Branding", "Marketing"].map(tag => (
              ...
              <div className="flex-1 space-y-10">
                ...
                <div className="max-w-3xl py-10 border-y border-zinc-100">
                  <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-zinc-900 mb-6">
                    기업과 사람을 잇는 매력적인 여정, 채용 브랜딩 전문가
                  </h2>
                  <div className="space-y-4">
                    <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      홍보, 마케팅, 채용 실무를 아우르는 폭넓은 경험을 쌓아왔습니다.
                    </p>
                    <p className="text-lg text-zinc-500 leading-relaxed font-medium">
                      기업의 채용 및 HR 과제에 대한 최적의 브랜딩 솔루션을 도출하여 기업과 우수 인재의 성공적인 연결을 이끌어갑니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-16 pt-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xl font-bold">HR Marketing & Communication</p>
                  </div>
                  <div className="space-y-2">
